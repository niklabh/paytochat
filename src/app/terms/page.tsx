        ...
        <div className="prose-legal mt-10 space-y-8 text-[15px] leading-relaxed text-foreground/90">
          <Section title="1. What Pay to Chat is">
            <p>
              ...
              paytochat.fun that lets a sender attach a USDC, USDT, USDG, or PUSD stablecoin
          ...
          <Section title="4. Payments and stablecoin transfers">
            <p>
              ...
              USDC, USDT, USDG, or PUSD directly from their own wallet to the recipient&apos;s
            ...
            <ul>
              ...
              <li>USDC, USDT, USDG, and PUSD are issued by third parties (Circle, Tether, Paxos, and Palm Azgar Finance respectively). Their issuer terms, including freeze, blacklist, and (for USDG&apos;s Solana mint) permanent-delegate powers, apply to balances independent of the Service.</li>
